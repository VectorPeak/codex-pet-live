...
from CodexPetLive.SpriteSettings.custom_utils import AvatarImage
from CodexPetLive.custom_widgets import RoundBarBase, LevelBadge
from CodexPetLive.utils import MaskPhrase, TimeConverter, replace_duplicates_in_list

from sys import platform
basedir = settings.BASEDIR
module_path = os.path.join(basedir, 'CodexPetLive/Dashboard/')
'''
if platform == 'win32':
    basedir = ''
    module_path = 'CodexPetLive/Dashboard/'
else:
