...
from .custom_utils import SpriteRangeSettingCard, SpriteComboBoxSettingCard, CustomColorSettingCard
...
if platform == 'win32':
    basedir = ''
    module_path = 'CodexPetLive/SpriteSettings/'
else:
...
class SettingInterface(ScrollArea):
    ...
    def __init__(self, parent=None):
        ...
        self.GravityCard = SpriteRangeSettingCard(
            1, 200, 0.01,
        ...
        self.DragCard = SpriteRangeSettingCard(
            0, 200, 0.01,
        ...
        self.VolumnCard = SpriteRangeSettingCard(
            0, 10, 0.1,
        ...
        self.ScaleCard = SpriteRangeSettingCard(
            1, 50, 0.1,
        ...
        self.DefaultPetCard = SpriteComboBoxSettingCard(
            pet_list,
            pet_list,
        ...
        self.languageCard = SpriteComboBoxSettingCard(
            lang_choices,
            lang_choices,
            FIF.LANGUAGE,
            self.tr('Language/语言'),
