...
from CodexPetLive.conf import checkItemMOD
import CodexPetLive.settings as settings
from CodexPetLive.utils import get_file_time
...
class ItemInterface(ScrollArea):
    ...
    def __init__(self, sizeHintSprite, parent=None):
        ...
        self.titleWidget.setFixedWidth(sizeHintSprite[0]-165)
    ...
    def __initCardLayout(self):
        ...
        self.ItemCardGroup = CharCardGroup(
            self.tr("Items"), self.sizeHintSprite, self.scrollWidget)
