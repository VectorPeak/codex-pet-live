...
from CodexPetLive import llm_chat_store
...
class RolePromptDialog(QDialog):
    def __init__(self, pet_name, current_prompt, parent=None):
        super().__init__(parent)
        self.pet_name = pet_name or "CodexPetLive"
...
class LLMChatInterface(QWidget):
    ...
    def _current_pet_name(self):
        return getattr(settings, "petname", "") or getattr(settings, "default_pet", "") or "CodexPetLive"
