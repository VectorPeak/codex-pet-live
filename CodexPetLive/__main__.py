...
from CodexPetLive.resource_paths import resource_root, set_runtime_cwd
...
def _load_runtime_components():
    ...
    from CodexPetLive.Accessory import SpriteAccessory
    from CodexPetLive.SpriteSettings.SpriteControlPanel import ControlMainWindow
    from CodexPetLive.Dashboard.DashboardUI import DashboardMainWindow
...
# pyinstaller --noconsole --icon="000.ico" --hidden-import="pynput.mouse._win32" --hidden-import="pynput.keyboard._win32" CodexPetLive/__main__.py

# For Mac:
# pyinstaller --windowed --icon 000.icns --add-data="res:res" --add-data="CodexPetLive:CodexPetLive" --hidden-import="pynput.mouse._darwin" --hidden-import="pynput.keyboard._darwin" CodexPetLive/__main__.py


class CodexPetLiveApp(QApplication):
    date_changed = Signal(QDate)

    def __init__(self, *args, **kwargs):
        _load_runtime_components()
        super(CodexPetLiveApp, self).__init__(*args, **kwargs)
