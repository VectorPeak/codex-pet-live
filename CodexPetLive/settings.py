...
import CodexPetLive.conf as conf
from CodexPetLive.conf import PetData, TaskData, ActData, ItemData
from CodexPetLive import app_identity
from CodexPetLive.resource_paths import resource_root, resource_path
