...
#from PeakDeskSprite.extra_windows import SpriteDialogue
from PeakDeskSprite.custom_widgets import SpriteDialogue, MenuSlider
from PeakDeskSprite.utils import SubPet_Manager
