...
from PeakDeskSprite.SpriteSettings.custom_utils import AvatarImage
from PeakDeskSprite.custom_widgets import RoundBarBase, LevelBadge
from PeakDeskSprite.utils import MaskPhrase, TimeConverter, replace_duplicates_in_list

from sys import platform
basedir = settings.BASEDIR
module_path = os.path.join(basedir, 'PeakDeskSprite/Dashboard/')
'''
if platform == 'win32':
    basedir = ''
    module_path = 'PeakDeskSprite/Dashboard/'
else:
...
class coinWidget(QWidget):
    ...
    def _init_widget(self):
        #self.label = CaptionLabel(self.tr('SpriteCoin'))
        ...
        #self.icon.setToolTip(self.tr('Sprite Coin'))
...
class itemTabWidget(QWidget):
    ...
    def __init__(self, items_data, item_types, sizeHintSprite, tab_index, parent=None):
        super().__init__(parent=parent)
        ...
        self.resize(self.sizeHintSprite[0] - 150, self.height())
        self._init_items()
        self.adjustSize()
...
class ShopView(QWidget):
    ...
    def __init__(self, items_data, sizeHintSprite, parent=None):
        super().__init__(parent=parent)
        ...
        self.resize(self.sizeHintSprite[0] - 140, self.height())
        self._init_items()
        #FluentStyleSheet.SETTING_CARD_GROUP.apply(self)
        self.adjustSize()
...
class AnimationGroup(QWidget):
    ...
    def __init__(self, sizeHintSprite, parent=None):
        super().__init__(parent=parent)
        self.sizeHintSprite = sizeHintSprite
    ...
    def __init_ui(self):
        ...
        '''
        self.setFixedSize(QSize(self.sizeHintSprite[0]-150, 800))
