...
from PeakDeskSprite.custom_widgets import SystemTray
from .custom_roundmenu import RoundMenu

from PeakDeskSprite.conf import *
from PeakDeskSprite.utils import *
from PeakDeskSprite.modules import *
from PeakDeskSprite.Accessory import MouseMoveManager
from PeakDeskSprite.custom_widgets import RoundBarBase, LevelBadge
...
# version
peakdesksprite_version = settings.VERSION
vf = open(os.path.join(runtime_data_dir(configdir), 'version'), 'w')
vf.write(peakdesksprite_version)
vf.close()
